...
execute if block ~ ~ ~ #snow:unsolid run scoreboard players set temp1 snow -56
...
execute if block ~ ~ ~ minecraft:ice run scoreboard players set temp1 snow -28
execute if block ~ ~ ~ minecraft:packed_ice run scoreboard players set temp1 snow -20
execute if block ~ ~ ~ minecraft:dirt_path run scoreboard players set temp1 snow -16
execute if block ~ ~ ~ minecraft:farmland run scoreboard players set temp1 snow -16
execute if block ~ ~ ~ #snow:half_unsolid run scoreboard players set temp1 snow -16
execute if block ~ ~ ~ minecraft:powder_snow run scoreboard players set temp1 snow -16
execute if block ~ ~ ~ minecraft:water run scoreboard players set temp1 snow -32
execute if block ~ ~ ~ #minecraft:leaves run scoreboard players set temp1 snow 24
